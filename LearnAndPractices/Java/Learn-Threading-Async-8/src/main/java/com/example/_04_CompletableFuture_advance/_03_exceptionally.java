...
public class _03_exceptionally {
    public static void main(String[] args) {
        ...
        CompletableFuture<String> bus = CompletableFuture.supplyAsync(() -> {
            ...
            ThreadUtils.printTimeAndThread(firstComeBus);
            if (firstComeBus.startsWith("700")) {
                throw new RuntimeException("hit a tree...");
            }
            return firstComeBus;
        }).exceptionally(e -> {
            ThreadUtils.printTimeAndThread(e.getMessage());
            ThreadUtils.printTimeAndThread("Xiaobai calls a taxi");
            return "taxi is called";
        });
